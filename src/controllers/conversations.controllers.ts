...
import { IGetConversationParams } from '~/models/requests/Conversation.requests'

export const getConversationsControllers = async (req: Request<IGetConversationParams>, res: Response) => {
